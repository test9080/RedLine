...
@implementation TUConstDeviceInfo
@synthesize iDevice;
...
+ (TUConstDeviceInfo *)sharedDevice {
    static TUConstDeviceInfo *sharedInstance = nil;
...
- (iDevice_t)machineToIdevice:(NSString*)machine
{
    if ([machine isEqualToString:@"iPhone1,1"])   return iPhone_1G;
    if ([machine isEqualToString:@"iPhone1,2"])   return iPhone_3G;
    if ([machine isEqualToString:@"iPhone2,1"])   return iPhone_3GS;
    if ([machine isEqualToString:@"iPhone3,1"])   return iPhone_4;
    if ([machine isEqualToString:@"iPhone3,3"])   return iPhone_4_Verizon;
    if ([machine isEqualToString:@"iPhone4,1"])   return iPhone_4S;
    if ([machine isEqualToString:@"iPhone5,1"])   return iPhone_5_GSM;
    if ([machine isEqualToString:@"iPhone5,2"])   return iPhone_5_CDMA;
    if ([machine isEqualToString:@"iPhone5,3"])   return iPhone_5C;
    if ([machine isEqualToString:@"iPhone5,4"])   return iPhone_5C;
    if ([machine isEqualToString:@"iPhone6,1"])   return iPhone_5S;
    if ([machine isEqualToString:@"iPhone6,2"])   return iPhone_5S;
    if ([machine isEqualToString:@"iPhone7,2"])   return iPhone_6;
    if ([machine isEqualToString:@"iPhone7,1"])   return iPhone_6_Plus;
    if ([machine isEqualToString:@"iPhone8,1"])   return iPhone_6S;
    if ([machine isEqualToString:@"iPhone8,2"])   return iPhone_6S_Plus;
    if ([machine isEqualToString:@"iPod1,1"])     return iPod_Touch_1G;
    if ([machine isEqualToString:@"iPod2,1"])     return iPod_Touch_2G;
    if ([machine isEqualToString:@"iPod3,1"])     return iPod_Touch_3G;
    if ([machine isEqualToString:@"iPod4,1"])     return iPod_Touch_4G;
    if ([machine isEqualToString:@"iPod5,1"])     return iPod_Touch_5;
    if ([machine isEqualToString:@"iPad1,1"])     return iPad_1;
    if ([machine isEqualToString:@"iPad2,1"])     return iPad_2_WiFi;
    if ([machine isEqualToString:@"iPad2,2"])     return iPad_2_GSM;
    if ([machine isEqualToString:@"iPad2,3"])     return iPad_2_CDMA;
    if ([machine isEqualToString:@"iPad2,4"])     return iPad_2_CDMA;
    if ([machine isEqualToString:@"iPad2,5"])     return iPad_Mini_WiFi;
    if ([machine isEqualToString:@"iPad2,6"])     return iPad_Mini_GSM;
    if ([machine isEqualToString:@"iPad2,7"])     return iPad_Mini_CDMA;
    if ([machine isEqualToString:@"iPad3,1"])     return iPad_3_WiFi;
    if ([machine isEqualToString:@"iPad3,2"])     return iPad_3_GSM;
    if ([machine isEqualToString:@"iPad3,3"])     return iPad_3_CDMA;
    if ([machine isEqualToString:@"iPad3,4"])     return iPad_4_WiFi;
    if ([machine isEqualToString:@"iPad3,5"])     return iPad_4_GSM;
    if ([machine isEqualToString:@"iPad3,6"])     return iPad_4_CDMA;
    if ([machine isEqualToString:@"iPad4,1"])     return iPad_Air;
    if ([machine isEqualToString:@"iPad4,2"])     return iPad_Air_Cellular;
    if ([machine isEqualToString:@"iPad5,3"])     return iPad_Air_2;
    if ([machine isEqualToString:@"iPad5,4"])     return iPad_Air_2_Cellular;
    if ([machine isEqualToString:@"iPad6,8"])     return iPad_Pro;
    if ([machine isEqualToString:@"iPad4,4"])     return iPad_Mini_2;
    if ([machine isEqualToString:@"iPad4,5"])     return iPad_Mini_2_Cellular;
    if ([machine isEqualToString:@"iPad4,7"])     return iPad_Mini_3;
    if ([machine isEqualToString:@"iPad4,8"])     return iPad_Mini_3_Cellular;
